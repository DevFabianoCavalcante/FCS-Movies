    ...
    <>
      ...
      <C.SectionFooter>
        ...
        <Question
          ...
          answer='O FCS MOVIES é um projeto pessoal que criei com o objetivo de ser um serviço fictício de streaming de filmes e séries. Ele simula uma plataforma onde os usuários podem explorar e assistir a diversos conteúdos de entretenimento.'
        />
        <Question
          question='Como Acessar o catálogo de filmes?'
          answer='Para acessar o catálogo de filmes, você precisa criar uma conta ou entrar na sua conta existente. Selecione a opção "Assinar" ou "Entrar" na página inicial e siga as instruções para completar o processo de registro ou login. Assim, você terá acesso completo ao nosso catálogo de filmes e séries.'
        />
        <Question
          question='Quais tecnologias foram aplicadas no projeto?'
          answer='No desenvolvimento do FCS MOVIES, utilizei várias tecnologias, incluindo React, React Router, Styled components, Firebase e Axios. Além disso, fiz uso de diversos hooks para gerenciar o estado e os efeitos colaterais dentro da aplicação, proporcionando uma experiência de usuário dinâmica e interativa.'
        />
      </C.SectionFooter>
